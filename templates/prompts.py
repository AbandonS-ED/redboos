...
5. 所有设计参数（颜色代码、字体大小、像素值、百分比等）不是显示内容，用括号注明仅供参考，例如：20pt（参考）、透明度20%（参考）、80px（参考）、圆角8px（参考）
...
示例(正确格式):
- 底部放置文字"从安装到精通"，20pt（参考）深靛蓝色，距底部120px（参考）
- 中央显示标题"Claude Code"，96pt（参考）超粗，深靛蓝色（参考色值：#1a1a2e）
- 纯色背景，浅灰蓝色（参考色值：#f0f4f8）
- 圆角矩形背景，深靛蓝色（参考色值：#1a1a2e），圆角8px（参考）
